...
** link:cities/cities-service/src/main/java/org/example/cities/repo/CityRepository.java[CityRepository.java]
* *To be developed*: Consuming a cloud data source using Spring Cloud Connectors
** link:cities/cities-service/templates/CloudDataSourceConfig.java[CloudDataSourceConfig.java]
